...
const CustomNodeFlow = () => {
  ...
  return (
    <div className='w-full pt-10 h-[100vh] bg-slate-100'>
      <div className='w-[900px] ml-10 flex bg-white rounded-lg border border-slate-300 shadow-[0px_0px_8px_1px_rgba(0,0,0,0.1)] overflow-hidden'>
        <div className=''>
