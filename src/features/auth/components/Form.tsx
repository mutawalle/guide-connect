  ...
  return (
    <div className='p-12 bg-white h-fit w-fit flex flex-col rounded-lg shadow-xl flex items-center'>  
            ...
            <form className="space-y-4 md:space-y-6 mt-8" action="#">
                <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5" placeholder="username" />
                <input type="password" placeholder="password" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5" />
